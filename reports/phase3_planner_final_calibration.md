...
```json
{
  ...
  "argument_accuracy": 0.58,
  "temporal_accuracy": 0.4166666666666667,
  "dependency_accuracy": 0.9,
  "unnecessary_tool_call_rate": 0.05263157894736842
}
```
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ
  ...
  - argument `get_market_snapshot`: missing matching Tool instance; expected={'symbol': '600519.SH'}; actual=None
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ
  ...
  - argument `get_market_snapshot`: missing matching Tool instance; expected={'symbol': '000001.SZ'}; actual=None
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ
  ...
  - argument `search_research_reports`: missing matching Tool instance; expected={'query': '澄海智造的经营展望研报', 'companies': ['澄海智造']}; actual=None
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ; temporal expectation differs
  ...
  - argument `search_research_reports`: missing matching Tool instance; expected={'query': '甲辰证券研究所截至 2026-06-30 对青禾医药的研报', 'companies': ['青禾医药'], 'brokers': ['甲辰证券研究所'], 'as_of': '2026-06-30'}; actual=None
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ
  ...
  - argument `search_research_reports`: missing matching Tool instance; expected={'query': '比较曜石半导体和云帆软件的最新经营研报', 'companies': ['曜石半导体', '云帆软件']}; actual=None
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ; temporal expectation differs
  ...
  - argument `search_research_reports`: missing matching Tool instance; expected={'query': '找衡川证券研究所截至 2026-05-01 对瀚源新能源和远陆物流的研报', 'companies': ['瀚源新能源', '远陆物流'], 'brokers': ['衡川证券研究所'], 'as_of': '2026-05-01'}; actual=None
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ; temporal expectation differs
  ...
  - argument `search_research_reports`: missing matching Tool instance; expected={'query': '查看截至 2026-04-30 的该公司研报', 'companies': ['沧澜消费'], 'as_of': '2026-04-30'}; actual=None
...
- reasons: one or more required values or non-default arguments differ
  ...
  - argument `search_regulatory_knowledge`: required value or non-default argument differs; expected={'query': '当前有效的最低保证金比例规则', 'issuer': '中证融资服务中心'}; actual={'query': '中证融资服务中心当前有效的最低保证金比例规则', 'issuer': None, 'as_of': None}
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ; temporal expectation differs
  ...
  - argument `search_regulatory_knowledge`: missing matching Tool instance; expected={'query': '截至 2025-12-31 的最低保证金比例规则', 'issuer': '中证融资服务中心', 'as_of': '2025-12-31'}; actual=None
...
- reasons: one or more required values or non-default arguments differ
  ...
  - argument `search_regulatory_knowledge`: required value or non-default argument differs; expected={'query': '当前有效的盘后固定价格交易细则', 'issuer': '东衡证券交易所'}; actual={'query': '东衡证券交易所盘后固定价格交易细则', 'issuer': None, 'as_of': None}
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ; temporal expectation differs
  ...
  - argument `search_regulatory_knowledge`: missing matching Tool instance; expected={'query': '截至 2025-07-20 的业绩预告公告', 'issuer': '澄海智造', 'as_of': '2025-07-20'}; actual=None
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ; temporal expectation differs
  ...
  - argument `search_business_knowledge`: missing matching Tool instance; expected={'query': '卖出股票后资金何时可以转出？', 'category': 'trading', 'as_of': '2025-12-31'}; actual=None
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ
  ...
  - argument `search_business_knowledge`: missing matching Tool instance; expected={'query': '两融账户维持担保比例低于预警线怎么办？', 'category': 'margin'}; actual=None
...
- reasons: one or more required values or non-default arguments differ
  ...
  - argument `search_business_knowledge`: required value or non-default argument differs; expected={'query': '新版条件单支持哪些有效期？', 'category': 'product_feature'}; actual={'query': '新版条件单支持哪些有效期？', 'category': 'trading', 'as_of': None}
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ; temporal expectation differs
  ...
  - argument `search_business_knowledge`: missing matching Tool instance; expected={'query': '融资交易为什么会放大亏损？', 'category': 'risk_notice', 'as_of': '2025-06-30'}; actual=None
...
- reasons: one or more required values or non-default arguments differ; dependency edges differ
  ...
  - argument `search_business_knowledge`: required value or non-default argument differs; expected={'query': '风险等级不匹配时能否购买产品的说明', 'category': 'risk_notice'}; actual={'query': '风险等级不匹配时能否购买产品的说明', 'category': None, 'as_of': None}
...
- validation: `True`
- tool / argument / temporal / dependency: `False` / `False` / `True` / `True`
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ; 2 unnecessary Tool call(s)

  - argument `search_regulatory_knowledge`: missing matching Tool instance; expected={'query': '当前最低保证金比例规则', 'issuer': '中证融资服务中心'}; actual=None
...
- reasons: one or more required values or non-default arguments differ; dependency edges differ
  ...
  - argument `search_research_reports`: required value or non-default argument differs; expected={'query': '截至 2026-06-30 的澄海智造研报', 'companies': ['澄海智造'], 'as_of': '2026-06-30'}; actual={'query': '澄海智造研报', 'companies': ['Cenghai Zhizao'], 'brokers': [], 'as_of': '2026-06-30'}
...
- reasons: one or more required values or non-default arguments differ
  ...
  - argument `search_research_reports`: required value or non-default argument differs; expected={'query': '截至 2026-05-01 的澄海智造研报', 'companies': ['澄海智造'], 'as_of': '2026-05-01'}; actual={'query': '澄海智造研报', 'companies': ['Cenghai Zhizao'], 'brokers': [], 'as_of': '2026-05-01'}
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ
  ...
  - argument `search_business_knowledge`: missing matching Tool instance; expected={'query': '为什么市价委托不一定按显示价格成交', 'category': 'trading'}; actual=None
...
- reasons: one or more required values or non-default arguments differ; dependency edges differ
  ...
  - argument `search_business_knowledge`: required value or non-default argument differs; expected={'query': '风险等级不匹配时能否购买产品', 'category': 'risk_notice'}; actual={'query': '风险等级不匹配时能否购买产品', 'category': 'product_feature', 'as_of': None}
