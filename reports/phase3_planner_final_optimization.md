...
- reasons: all scored dimensions correct
  ...
  - argument `search_research_reports` (acceptable): query wording is semantically equivalent; expected={'query': '比较曜石半导体和云帆软件的最新经营研报', 'companies': ['曜石半导体', '云帆软件']}; actual={'query': '曜石半导体和云帆软件的最新经营研报', 'companies': ['曜石半导体', '云帆软件'], 'brokers': [], 'as_of': None}
...
- reasons: one or more required values or non-default arguments differ; dependency edges differ
  ...
  - argument `search_business_knowledge` (incorrect): required value or non-default argument differs; expected={'query': '风险等级不匹配时能否购买产品的说明', 'category': 'risk_notice'}; actual={'query': '风险等级不匹配时能否购买产品的说明', 'category': None, 'as_of': None}
