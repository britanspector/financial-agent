...
```json
{
  ...
  "valid_plan_rate": 1.0,
  "tool_selection_accuracy": 0.775,
  "argument_accuracy": 0.74,
  "temporal_accuracy": 0.6666666666666666,
  "dependency_accuracy": 0.9,
  "unnecessary_tool_call_rate": 0.0851063829787234
}
```
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ
  ...
  - argument `get_market_snapshot` (incorrect): missing matching Tool instance; expected={'symbol': '000001.SZ'}; actual=None
...
- reasons: all scored dimensions correct
  ...
  - argument `search_research_reports` (acceptable): query wording is semantically equivalent; expected={'query': '澄海智造的经营展望研报', 'companies': ['澄海智造']}; actual={'query': '澄海智造的经营展望', 'companies': ['澄海智造'], 'brokers': [], 'as_of': None}
...
- reasons: all scored dimensions correct
  ...
  - argument `search_research_reports` (acceptable): query wording is semantically equivalent; expected={'query': '甲辰证券研究所截至 2026-06-30 对青禾医药的研报', 'companies': ['青禾医药'], 'brokers': ['甲辰证券研究所'], 'as_of': '2026-06-30'}; actual={'query': '青禾医药研报', 'companies': ['青禾医药'], 'brokers': ['甲辰证券研究所'], 'as_of': '2026-06-30'}
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ; 1 unnecessary Tool call(s)
  ...
  - argument `search_research_reports` (incorrect): required value or non-default argument differs; expected={'query': '比较曜石半导体和云帆软件的最新经营研报', 'companies': ['曜石半导体', '云帆软件']}; actual={'query': '曜石半导体最新经营研报', 'companies': ['曜石半导体'], 'brokers': [], 'as_of': None}
...
- reasons: one or more required values or non-default arguments differ
  ...
  - argument `search_research_reports` (incorrect): required value or non-default argument differs; expected={'query': '找衡川证券研究所截至 2026-05-01 对瀚源新能源和远陆物流的研报', 'companies': ['瀚源新能源', '远陆物流'], 'brokers': ['衡川证券研究所'], 'as_of': '2026-05-01'}; actual={'query': '瀚源新能源和远陆物流的研报', 'companies': ['Hanyuan New Energy', 'Yuanlu Logistics'], 'brokers': ['Hengchuan Securities Research Institute'], 'as_of': '2026-05-01'}
...
- reasons: tool selection differs from selected expected plan; one or more required values or non-default arguments differ; temporal expectation differs
  ...
  - argument `search_research_reports` (incorrect): missing matching Tool instance; expected={'query': '查看截至 2026-04-30 的该公司研报', 'companies': ['沧澜消费'], 'as_of': '2026-04-30'}; actual=None
...
- reasons: all scored dimensions correct
  ...
  - argument `search_regulatory_knowledge` (acceptable): entity filter omitted but preserved verbatim in query; expected={'query': '截至 2025-12-31 的最低保证金比例规则', 'issuer': '中证融资服务中心', 'as_of': '2025-12-31'}; actual={'query': '中证融资服务中心最低保证金比例规则', 'issuer': None, 'as_of': '2025-12-31'}
...
- validation: `True`
- tool / argument / temporal / dependency: `True` / `False` / `False` / `True`
- reasons: one or more required values or non-default arguments differ; temporal expectation differs

  - argument `search_business_knowledge` (incorrect): required value or non-default argument differs; expected={'query': '融资交易为什么会放大亏损？', 'category': 'risk_notice', 'as_of': '2025-06-30'}; actual={'query': '融资交易为什么会放大亏损？', 'category': 'risk_notice', 'as_of': None}
