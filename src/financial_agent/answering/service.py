...
class AnswerWriter:
    def __init__(self, provider: AnswerProvider, catalog: OutputCatalog) -> None:
    ...
    def _generate(self, request, plan, results, *, previous_draft=None, feedback=None) -> DraftAnswer:
        raw = self._provider.generate(
            build_answer_messages(request, plan, results, previous_draft=previous_draft, feedback=feedback),
